 ...
 * See `https://spider-baby-hub.web.app/blog/route-defs-tutorial` for details.
 */
export class NgDemoAppRouteDefs {
     ...
     * See `https://spider-baby-hub.web.app/blog/route-defs-tutorial`.
     */
    static routes = {
        /** Relative routes for the sub-section areas. */
        // section1: NgDemoSection1RoutesDefs.routes,
        // section2: NgDemoSection2RoutesDefs.routes,
    };
     ...
     */
    static fullPaths = {
        /** Full paths for the sub-section areas */
        // section1: NgDemoSection1RoutesDefs.fullPathFn(this.BASE),
        // section2: NgDemoSection2RoutesDefs.fullPathFn(this.BASE),
    };
     ...
     */
    static fullPathsWithSlash = wrapWithLeadingSlash(NgDemoAppRouteDefs.fullPaths);
